...
%  DRAFT v0.1 (2026-07-11) — generated from the C1_lattice_realism
%  solution log §§27,34,36,37,38,40,41; all numerical claims trace to
%  code/receipt_d36_cutgen.txt, code/receipt_d36_cs.txt and the exact
%  ancillary data (see paper/README.md for the provenance map and the
%  FINAL-POLISH checklist before any submission).
% =====================================================================
...
\newcommand{\TODO}[1]{\textbf{[FINAL-POLISH: #1]}}
